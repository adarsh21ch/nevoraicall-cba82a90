          ...
          <div className="prose prose-sm max-w-none space-y-6 text-foreground">
            <section className="bg-primary/5 border border-primary/15 rounded-xl p-4">
              <p className="text-muted-foreground leading-relaxed m-0">
                Nevorai Call by Nevorai respects your privacy. This policy explains what data we collect, how we use it, and how we protect it. We comply with the Information Technology Act, 2000 and its amendments applicable in India.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Nevorai Call is a product of Nevorai Technologies, built for network marketers and sales professionals to manage calls, leads and follow-ups. References to "Nevorai Call", "we", "us" or "our" mean Nevorai Technologies and the Nevorai Call application.
              </p>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
                <li>Provide and improve the Nevorai Call service.</li>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                The contacts and leads you import into Nevorai Call belong to you. We store them securely solely to power the app for you. We do not access, use, or share your lead data for any other purpose. If you delete your account, all lead data is permanently deleted within 30 days.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Nevorai Call is not intended for users under 18. We do not knowingly collect data from minors. Contact us if you believe a minor has created an account, and we will delete it.
              </p>
            </section>
