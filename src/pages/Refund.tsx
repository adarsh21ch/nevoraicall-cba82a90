          ...
          <div className="prose prose-sm max-w-none space-y-6 text-foreground">
            <section className="bg-primary/5 border border-primary/15 rounded-xl p-4">
              <p className="text-muted-foreground leading-relaxed m-0">
                Nevorai Call is a digital subscription service. Refund eligibility depends on the plan you purchased. Read this policy carefully before subscribing.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Nevorai Call is a digital, subscription-based SaaS product delivered entirely online. No physical products are shipped. Once you subscribe, you get immediate access for the duration of your billing period.
              </p>
            </section>
              ...
              <div className="space-y-3 mt-2">
                <div className="p-3 rounded-lg bg-card border border-border">
                  ...
                  <p className="text-muted-foreground text-sm m-0">
                    Payments for the Nevorai Call monthly plan are <strong className="text-destructive">NON-REFUNDABLE</strong>. You retain access for the full month after subscribing, but no refunds are issued regardless of cancellation timing.
                  </p>
                </div>
                ...
                <div className="p-3 rounded-lg bg-card border border-border">
                  ...
                  <p className="text-muted-foreground text-sm m-0">
                    Payments for Nevorai Call yearly plans (including discounted offers) are eligible for a <strong className="text-emerald-600">full refund within 7 days</strong> of the purchase date. After 7 days, yearly payments become <strong className="text-destructive">NON-REFUNDABLE</strong>.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                We may update this Refund Policy from time to time. The latest version will always be available on this page. Continued use of Nevorai Call after changes constitutes acceptance.
              </p>
            </section>
