...
export default function Dashboard() {
  ...
  const { prospects, loading, addProspect, updateProspect, deleteProspect, bulkDeleteProspects, restoreProspects, importProspects, reorderProspects, refetch } = useProspects();
