...
const ONBOARDING_SEQUENCES: NotificationSequence[] = [
  {
    ...
    body: 'You signed up for Nevorai! Import your first leads in 2 minutes.',
  },
  {
    triggerType: 'onboarding_day1',
    condition: 'signup_day1_not_step3',
    title: 'One small step 📋',
    body: "You're 3 taps away from organizing your first prospect. Open Nevorai now.",
  },
  {
    triggerType: 'onboarding_day3',
    condition: 'signup_day3_not_complete',
    title: "Don't lose momentum 🔥",
    body: 'Top network marketers follow up 5x more. Nevorai makes it automatic.',
  },
  {
...
const REENGAGEMENT_SEQUENCES: NotificationSequence[] = [
  ...
  },
  {
    ...
    body: "What's stopping you from using Nevorai? We want to make it better for you.",
  },
  {
